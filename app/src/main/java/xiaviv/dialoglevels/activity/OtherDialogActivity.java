...
public class OtherDialogActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tv_activity)).setText("This is OtherDialogActivity");
    ...
    public static void launch(Activity activity) {
        DialogTag dialogTag = new DialogTag(DialogManger.OTHER_PRIORITY, UUID.randomUUID().toString());
        if (DialogManger.getInstance(activity).canShow(dialogTag)) {
            Intent intent = new Intent(activity, OtherDialogActivity.class);
