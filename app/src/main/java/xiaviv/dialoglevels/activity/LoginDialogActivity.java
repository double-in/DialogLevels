...
public class LoginDialogActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tv_activity)).setText("This is LoginDialogActivity");
    ...
    public static void launch(Activity activity) {
        DialogTag dialogTag = new DialogTag(DialogManger.LOGIN_PRIORITY, UUID.randomUUID().toString());
