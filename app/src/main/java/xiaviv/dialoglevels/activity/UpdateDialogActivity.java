...
public class UpdateDialogActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tv_activity)).setText("This is UpdateDialogActivity");
    ...
    public static void launch(Activity activity) {
        DialogTag dialogTag = new DialogTag(DialogManger.UPDATE_PRIORITY, UUID.randomUUID().toString());
